...
console.log('%c👋 Salut ! Merci de visiter mon portfolio !', 'color: #dc2626; font-size: 16px; font-weight: bold;');
console.log('%cSi vous cherchez un développeur passionné, contactez-moi ! 🚀', 'color: #16a34a; font-size: 14px;');